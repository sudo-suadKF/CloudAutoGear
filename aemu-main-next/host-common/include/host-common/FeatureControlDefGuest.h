...
FEATURE_CONTROL_ITEM(XrModeGlassesUI, 113)
FEATURE_CONTROL_ITEM(MicrophoneToggleUI, 114)
FEATURE_CONTROL_ITEM(QemuCameraSensorOrientation, 119)
FEATURE_CONTROL_ITEM(XrDimming, 122)
FEATURE_CONTROL_ITEM(XrHandAndEyePointers, 123)
FEATURE_CONTROL_ITEM(Nfc, 124)
FEATURE_CONTROL_ITEM(XrStatusLed, 125)
