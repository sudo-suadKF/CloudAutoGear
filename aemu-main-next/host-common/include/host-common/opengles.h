...
AEMU_EXPORT void android_setOpenglesScreenBackground(int width, int height,
                                                     const uint8_t* rgbaData);

AEMU_EXPORT void android_setOpenglesDisplayLayout(int screenWidth, int screenHeight,
