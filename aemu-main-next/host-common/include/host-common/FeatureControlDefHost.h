...
FEATURE_CONTROL_ITEM(ForceLavapipe, 115)
FEATURE_CONTROL_ITEM(ForceLavapipeForSoftwareRendering, 116)
FEATURE_CONTROL_ITEM(ForceGpuHost, 117)
FEATURE_CONTROL_ITEM(ForceGpuSoftware, 118)
FEATURE_CONTROL_ITEM(NetsimX, 120)
FEATURE_CONTROL_ITEM(VulkanProtectedMemoryEmulation, 121)
FEATURE_CONTROL_ITEM(VulkanUseDedicatedAhbMemoryType, 126)
