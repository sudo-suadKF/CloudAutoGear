...
log_version_info() {
  ...
  echo 'version: launch_script: 0+untagged.4.g7bba36c'
...
LAUNCH_CMD+=("-shell-serial" "file:/tmp/android-unknown/kernel.log" "-logcat-output" "/tmp/android-unknown/logcat.log" )
